...
This is the **planning source of truth** for product validation — the definitions and assignments of what we're trying to prove. It works top-down:

1. **Winning Hypotheses** (3x) - If these are true, we succeed
2. **Big Hairy Questions** (BHQs) - How we test each hypothesis in smaller pieces
3. **Small Hairy Questions** (SHQs) - Concrete validations assigned per milestone, tracked as Epics in ClickUp

Each SHQ is linked to a ClickUp Epic in the [SHQ Tracker](https://app.clickup.com/36181078/v/l/li/901324723345) list. Sprint-level evaluation of SHQ progress produces the generated **Validation Roadmap** (`generated/validation_roadmap.md`), which shows current statuses, confidence trends, and sprint evaluation history.

**Important**: BHQs and SHQs are **not necessarily pod-specific**. Some belong clearly to one pod, but many are cross-pod "cohesive product" questions that require contributions from multiple teams. Pod plans and feature docs reference SHQs by ID — they don't duplicate them.

> **Companion files**:
> - `generated/validation_roadmap.md` — Current statuses, confidence trends, Gantt, sprint eval log (generated by `/validation-review`)
> - `planning/operating_cadence.md` — Defines the sprint/monthly/milestone rhythms for keeping validation current
...
gantt
    ...
    section WH-2 Empire
    E1 Map Exploration - 5/7 +6 M&Ms      :active, 2025-07-08, 2026-06-23
...
| Systems Validation | SHQ3-23: Beyond initial stickiness, does depth of play in our battle mechanics remain interesting and engaging for the first three days?                                 | ANSWERED ✅ |
...
| Systems Validation | SHQ3-25: (paper) Does our GTM hero roster cover both the rarity spread necessary for monetization and the roles & mechanics spread necessary for broad collection? | ANSWERED ✅ |
| Systems Validation | SHQ3-26: Is the player motivated to collect specific and varied heroes and troops against each planned game mode (Dungeons, XP farm, Conquest, etc)?               | ANSWERED ✅ |
| M&Ms               | SHQ3-26: Is the player motivated to collect specific and varied heroes and troops against each planned game mode (Dungeons, XP farm, Conquest, etc)? | PENDING VALIDATION |
| M&Ms               | SHQ4-2: Can players understand the role and abilities of all six starter heroes, and do player metagame progression choices vary per hero in support of that role? | NOT STARTED |
...
| Systems Validation | SHQ3-27: Can we effectively and scalably build battles across all game modes?                                                                                                                              | ANSWERED ✅ |
| Systems Validation | SHQ3-28: Are we confident in our pipeline hero/unit production? Can we prove it with animation requirements and get a full understanding on how long it takes to build a hero/unit for long term planning? | ANSWERED ✅ |
| M&Ms               | SHQ3-27: Can we establish an effective, scalable process for building battles across all game modes, with confidence on early, mid, and late game? | IN PROGRESS |
| M&Ms               | SHQ3-28: Validate the unit production pipeline to ensure it works in practice and supports confident long-term projections. | IN PROGRESS |
...
| M&Ms               | SHQ4-4: Does the territory map remain highly functional and readable with real art, allowing players to clearly identify tile types, plan expansions, and make confident decisions without confusion or visual clutter? | NOT STARTED |
| M&Ms               | SHQ4-5: Do narrative beats provide clear, motivating goals that drive players to explore the map and engage with key progression content? | NOT STARTED |
| M&Ms               | SHQ4-6: Do we have a clear UX vision for how the player will engage and navigate between home empire, limited time maps (whirlpool), and multiplayer — with an understanding of how each supports their goals? | NOT STARTED |
| M&Ms               | SHQ4-11: Can the player quickly grasp map objectives (core site, barracks, story shards) and make navigation decisions? | NOT STARTED |
...
| Systems Validation | SHQ3-8: Can we create progression opportunities to come back and finish the next session that are high-impact and time sensitive?                                   | IN PROGRESS |
| Systems Validation | SHQ3-9: Does the map feel dynamic, leading players to adjust their priorities in ways that feel exciting and worthwhile?                                            | ANSWERED ✅ |
...
| M&Ms               | SHQ4-10: (Paper) Do we have confidence that the economy model provides sufficient depth and viable levers for future monetisation? | NOT STARTED |
...
| ID | SHQ | Parent BHQ | ClickUp | Status | Notes |
|----|-----|-----------|---------|--------|-------|
| SHQ3-24 | Does our new art direction maintain the level of clarity necessary for this to be clear? | BHQ-B2 | [CHI-34276](https://app.clickup.com/t/869b98a03) | IN PROGRESS | Continuing from SV |
...
| ID | SHQ | Parent BHQ | ClickUp | Status | Notes |
|----|-----|-----------|---------|--------|-------|
| SHQ3-1 | Does the production pipeline successfully deliver diverse, high-quality territory maps at scale that feel unique and handcrafted to the player, while maintaining a modular workflow that meets internal time and resource constraints? | BHQ-E1 | [CHI-34281](https://app.clickup.com/t/869b98ath) | IN PROGRESS | Reworded from SV |
| SHQ4-3 | Does the world map presentation allow the player to quickly form engagement goals for their session, across conquest, dungeons, roaming monsters, and empire management tasks? | BHQ-E1 | [CHI-36331](https://app.clickup.com/t/86aghxxqy) | NOT STARTED | New |
| SHQ4-4 | Does the territory map remain highly functional and readable with real art, allowing players to clearly identify tile types, plan expansions, and make confident decisions without confusion or visual clutter? | BHQ-E1 | [CHI-36327](https://app.clickup.com/t/86aghw010) | NOT STARTED | New |
| SHQ4-5 | Do narrative beats provide clear, motivating goals that drive players to explore the map and engage with key progression content? | BHQ-E1 | [CHI-36328](https://app.clickup.com/t/86aghw017) | NOT STARTED | New |
| SHQ4-6 | Do we have a clear UX vision for how the player will engage and navigate between home empire, limited time maps (whirlpool), and multiplayer — with an understanding of how each supports their goals? | BHQ-E1 | ⚠️ Needs Epic | NOT STARTED | New — needs ClickUp Epic created |
| SHQ4-11 | Can the player quickly grasp map objectives (core site, barracks, story shards) and make navigation decisions? | BHQ-E1 | [CHI-36335](https://app.clickup.com/t/86aghxz8f) | NOT STARTED | New — from ClickUp SHQ 15 |

#### Monetisation Hypothesis SHQs (WH-3)

| ID | SHQ | Parent BHQ | ClickUp | Status | Notes |
|----|-----|-----------|---------|--------|-------|
| SHQ4-7 | Do players understand and engage with vertical empire progression (buildings, research, governors, bonuses) as meaningful investments that increase power and unlock strategic options? | BHQ-M3 | [CHI-36330](https://app.clickup.com/t/86aghxxr7) | NOT STARTED | New |
| SHQ4-8 | Are players motivated to return session to session across three days to pursue progression goals (heroes, empire, research) while engaging in varied game mechanics and game modes? | BHQ-M3 | [CHI-36333](https://app.clickup.com/t/86aghxxru) | NOT STARTED | New |
| SHQ4-9 | Do players face meaningful resource tension across systems that forces them to prioritise and delay investments, driving strategic decision making? | BHQ-M3 | [CHI-36332](https://app.clickup.com/t/86aghxxrj) | NOT STARTED | New |
| SHQ4-10 | (Paper) Do we have confidence that the economy model provides sufficient depth and viable levers for future monetisation? | BHQ-M3 | [CHI-36334](https://app.clickup.com/t/86aghxz81) | NOT STARTED | New |
| SHQ4-12 | Does multiplayer pacing encourage the player to login multiple times a day to take specific actions? | BHQ-M4 | [CHI-36336](https://app.clickup.com/t/86aghxz8w) | NOT STARTED | New — from ClickUp SHQ 16 |

**M&Ms Summary**: 17 SHQs — 6 Battle, 7 Empire, 5 Monetisation. 5 continuing from SV (SHQ3-1, SHQ3-24, SHQ3-26, SHQ3-27, SHQ3-28), 12 new (SHQ4-1 through SHQ4-12). Next M&Ms SHQ: **SHQ4-13**. Next new milestone SHQ: **SHQ5-1** (Beta Prep) or **SHQ6-1** (M&C).

### SHQ Numbering Scheme

Format: **SHQ[milestone]-[sequence]**

- First number = milestone where the SHQ was created (1=Core Experience, 2=Core Loop, 3=Systems Validation, 4=M&Ms, 5=Beta Prep, 6=M&C, 7=Live Ops, 8=Soft Launch)
- Second number = sequence within that milestone
- An SHQ that carries forward to the next milestone **keeps its original ID** (e.g., SHQ3-1 started in SV, continues in M&Ms — still called SHQ3-1)

### ClickUp SHQ Tracker Reconciliation

> **Numbering note**: The ClickUp SHQ Tracker uses milestone-specific numbering (SHQ 01-16 for M&Ms). The brain uses the global format SHQ[milestone]-[seq]. ClickUp task titles should be updated to match the brain IDs for consistency. The ClickUp links above resolve regardless of title.
...
> **Note**: This section will move to `generated/validation_roadmap.md` once the evaluation loop is running. Kept here during transition so the template is preserved.

Track confidence changes sprint-over-sprint. Each entry captures: status changes (from ClickUp), qualitative findings (from pod leads), and confidence adjustments.

### Sprint XX (Date Range) — TEMPLATE

**Evaluator**: [Who ran this evaluation]

#### Status Changes (from ClickUp SHQ Tracker)
| SHQ | Previous Status | New Status | Evidence |
|-----|----------------|------------|----------|
| SHQxx | NOT STARTED | IN PROGRESS | [what happened] |
...
#### Key Findings
- [Qualitative insights ClickUp can't tell you — playtest results, design pivots, surprises]

#### Open Concerns
- [Blockers, risks, things that need attention before next sprint]

---

## Validation Status Summary

> **Note**: This visualization will move to `generated/validation_roadmap.md` once the evaluation loop is running.
...
### SHQ Numbering
- Format: **SHQ[milestone]-[sequence]** (e.g., SHQ3-7 = 7th SHQ created in milestone 3, Systems Validation)
- Milestones: 1=Core Experience, 2=Core Loop, 3=Systems Validation, 4=M&Ms, 5=Beta Prep, 6=M&C, 7=Live Ops, 8=Soft Launch
- SHQs that carry forward to the next milestone keep their original ID
...
### How SHQs Connect to Execution

Each SHQ traces through a chain that enables sprint-level evaluation:

```
ValidationPlan.md (SHQ definition + ClickUp Epic ID)
  → ClickUp SHQ Tracker (Epic with child tasks)
    → ClickUp Sprint Lists (tasks assigned to sprints)
      → Sprint evaluation (status check each sprint)
        → generated/validation_roadmap.md (current state)
```

Example:
```
SHQ3-1: "Does the production pipeline deliver diverse, high-quality territory maps at scale?"
  → ClickUp Epic: CHI-34281
    → Child tasks: map pipeline tooling, art review, performance profiling
      → Sprint 26: 2 of 5 child tasks complete
        → Validation Roadmap: SHQ3-1 IN PROGRESS (40% of tasks done)
```

**If an SHQ has no ClickUp Epic**: it cannot be evaluated by the sprint evaluation loop. All M&Ms SHQs should have a ClickUp Epic in the [SHQ Tracker](https://app.clickup.com/36181078/v/l/li/901324723345).

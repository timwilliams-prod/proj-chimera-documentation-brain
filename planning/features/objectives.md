...
**What Objectives Must Prove**: Players have clear, trackable goals on the territory map that guide exploration and provide a sense of progress.
...
Player-facing objectives system on the territory map. Track progress, show rewards, guide exploration.
...
|-----------|-----------|---------|
| Territory Map | Part of | Objectives track map exploration progress |

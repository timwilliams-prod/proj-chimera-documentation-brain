...
**What This Must Prove**: Time-limited objectives create urgency that drives engagement without feeling punishing.
...
Time-limited objectives with bonus rewards. Daily/weekly rotation, escalating difficulty. M&C milestone.
...
|-----------|-----------|---------|
| Objectives | Related | Extends the objectives system |

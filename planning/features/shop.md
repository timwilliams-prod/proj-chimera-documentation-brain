...
**What Shop Must Prove**: In-game store provides clear value propositions that drive conversion and spend depth.
...
In-game store. Premium currency purchases, bundles, special offers, IAP integration. M&C milestone.
...
|-----------|-----------|---------|
| Hero Summoning | Related | Shop sells summoning currency |

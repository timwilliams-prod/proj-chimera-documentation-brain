...
|----------|-----------|------------|------------|-------|
| Diana Vasilescu | Design | 10 | 1. WME spec finalization: Multiple Nodes per Territory ([CHI-36655](https://app.clickup.com/t/86ah532g2)) 2. Narrative for Region 2 - main beats top level and image generation ([CHI-36656](https://app.clickup.com/t/86ah532hx)) 3. WME spec finalization: Game Modes to be kicked off next sprint ([CHI-36657](https://app.clickup.com/t/86ah532ka)) 4. Feedback for Territory Map Visual Target + Vertical Slice ([CHI-36658](https://app.clickup.com/t/86ah532ku)) | Critical week-1 design alignment with Henrique. |
| Jacob Siegel | Design | 10 | 1. World Map Reshaping ([CHI-36659](https://app.clickup.com/t/86ah532n6)) 2. T6 total refresh for day 2 narrative ([CHI-36660](https://app.clickup.com/t/86ah532pk)) | Next: T8 and T9 creation |
| Elise Cole | Design | **9** | 1. **Figma Map agentic research** ([CHI-36575](https://app.clickup.com/t/86agw4bfz)) — primary 2. Map Creation flow — high prio ([CHI-36661](https://app.clickup.com/t/86ah532qt)) 3. T5 total refresh for day 2 narrative ([CHI-36662](https://app.clickup.com/t/86ah532t5)) | **Out 4/28 (first day). Next: T7** |
| Yura Rusin | UX | **9** | 1. WME UX — Game Modes wireframes/flows + open Qs log ([CHI-36663](https://app.clickup.com/t/86ah532up)) 2. Prep for OOO time + handoff to Lina ([CHI-36664](https://app.clickup.com/t/86ah532wb)) | **Maternity leave starts 5/11** — loses sprint day 10 + all of M&Ms remainder (S29-S31). Sub-effort 3 deliberately left to Diana as flex room for iterations. |
| Henrique De Lima | Eng | **9** | 1. **WME — Multiple Nodes per Territory implementation** ([CHI-36665](https://app.clickup.com/t/86ah53375)) | **May 1 OOO.** Sole client engineer. Partial appts 4/29, 5/6. Tutorial Migration parked — Henrique focused on WME. Spec not 100% ready at sprint start — week-1 alignment with Diana required. |
| Laura Santana | QA | **9** | 1. WME smoke-test prep ([CHI-36666](https://app.clickup.com/t/86ah5338a)) 2. Bug verification ([CHI-36668](https://app.clickup.com/t/86ah5339v)) | **May 1 OOO.** Tutorial QA dropped — Tutorial work parked. |
| Marcos Teles | Tech Art | **9-10** | 1. **Territory Map Optimization Review** (collab w Pedro) ([CHI-36669](https://app.clickup.com/t/86ah533bc)) 2. Water VFX/Shader exploration 3. WME TA support ([CHI-36670](https://app.clickup.com/t/86ah533ch)) 4. Pop-up overlay blur bug (link bug) | **May 1 OOO.** Empire-embedded artist. |
| Guilherme Lascasas | 2D Env Concept | **9-10** | 1. Territory Map Visual Target assist ([CHI-36671](https://app.clickup.com/t/86ah533d7)) 2. WME asset support ([CHI-36667](https://app.clickup.com/t/86ah533e0)) | Empire-embedded artist. |
| Thiago Saraiva | Senior 3D | **9** | 1. Territory Map vertical slice tile creation ([CHI-36672](https://app.clickup.com/t/86ah533r5)) 2. WME asset support ([CHI-36673](https://app.clickup.com/t/86ah533t1)) | **Out 4/30, May 1.** Empire-embedded artist. |

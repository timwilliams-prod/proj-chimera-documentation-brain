...
var SPRINT_DATA = {
  ...
  pods: [
    ...
    // ──────────────────────────────────────────
    {
      ...
      people: [
        ...
        { name: "Elise Cole", discipline: "Design", avail: 9, total: 10, priorities: ["Figma Map agentic research (CHI-36575) — primary", "T8 Design Prep (CHI-36576) — continues into T8 Implementation, lower priority", "WME design support"], notes: "Out 4/28 (first day). S27 carry-over confirmed continuing. Agentic research is the higher-priority track.", flags: ["carry-over", "pto"] },
        ...
        { name: "Thiago Saraiva", discipline: "Senior 3D", avail: 9, total: 10, priorities: ["3D blockouts (Empire — terrain objects, building blockouts)", "WME asset support for Henrique kickoff"], notes: "Out 4/30. May 1 also pending verification (if also off, would be 8 days).", flags: ["pto"] },
    ...
    // ──────────────────────────────────────────
    {
      ...
      people: [
        ...
        { name: "Christopher Fidalgo", discipline: "Design", avail: 10, total: 10, priorities: ["Narrative/Tutorial design", "Any S27 carry-over (CHI-36250 T5/T6 rewards if still open)", "Add source of Gacha scrolls to game economy (from roaming monsters)"], notes: "Risk: if Chris's S27 tasks didn't close, S28 starts overloaded.", flags: [] },
  ...
  summary: {
    ...
    checkpoint_coverage: [
      ...
      { pod: "Battle", checkpoint_goal: "Battle HUD Implementation (eng + asset integration)", sprint_work: "Sprint 1 of 4 begins — Jota; Miguel Duran cross-pod UI art", status: "on_track" },

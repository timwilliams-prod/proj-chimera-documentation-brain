# /ask — Ask the Documentation Brain (alias for /eda)

The user has asked a question of the Lotus Documentation Brain. This routes to **Eda**, the brain's concierge subagent.
...
Agent({
  ...
  prompt: <the user's request, exactly as they typed it after /ask>
})
```

...
### `/roadmap-update`
Updates pod plans and regenerates the Feature Roadmap Gantt chart.

**What It Does**:
1. Reads the relevant pod plan(s)
2. Asks for specific changes
3. Validates against dependencies and capacity
4. Updates pod plan file(s)
...
### `/validation-review`
Evaluates and updates the Validation Roadmap - reviews SHQ progress, rolls up to BHQ/WH confidence, checks feature-validation alignment.
...
| `roadmap.md` | Auto-generated by skill | 0 min |
